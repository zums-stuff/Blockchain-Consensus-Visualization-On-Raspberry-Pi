    ...
    try:
        ...
        with open("emissions.csv", "r") as f:
            ...
            if last_row:
                ...
                return round(energy, 6), round(emissions, 6)
    except Exception:
        pass
    return 0.0, 0.0
        ...
        <div class="header">
            ...
            <div style="text-align:right;">
                ...
                <div style="margin-top:5px; font-size:0.75rem;">
                    <span style="color:#00e5ff;">Energía: <span id="energyUsage">0.0</span> kWh</span> |
                    <span style="color:#ff5252;">CO₂: <span id="carbonEmissions">0.0</span> g</span>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        function update() {
            fetch('/data').then(r => r.json()).then(data => {
                ...
                //CodeCarbon Energía
                document.getElementById('energyUsage').innerText = data.energy_consumed || "0.0";
                document.getElementById('carbonEmissions').innerText = (data.emissions ? (data.emissions * 1000).toFixed(4) : "0.0");
...
def update_loop():
    ...
    while True:
        energy_consumed, emissions = get_carbon_metrics()
        
        state["energy_consumed"] = energy_consumed
